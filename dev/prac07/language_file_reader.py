...
def main():
    ...
    for line in in_file:
        ...
        # Reflection and point_arithmetic is stored as a string (Yes/No) and we want a Boolean
        reflection = parts[2] == "Yes"
        point_arithmetic = parts[4] == "Yes"
        # Construct a ProgrammingLanguage object using the elements
        # year should be an int
        language = ProgrammingLanguage(parts[0], parts[1], reflection, int(parts[3]), point_arithmetic)
